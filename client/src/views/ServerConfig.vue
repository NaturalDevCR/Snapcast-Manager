...
import AddEditSourceDialog from '../components/server-config/AddEditSourceDialog.vue';
...
// Task 43: moved into AddEditSourceDialog.vue -- this view only needs a
// template ref to imperatively open it (see
// addEditSourceDialog.value?.openAdd() / .openEdit(idx) below).
...
<template>
  <Layout>
      ...
      <!-- ==================== ADD SOURCE DIALOG ==================== -->
      <!-- Task 43: extracted to components/server-config/AddEditSourceDialog.vue -->
      <AddEditSourceDialog
